...
#define INCLUDED_haxe_xml__Fast_AttribAccess_Impl_
...
HX_DECLARE_CLASS3(haxe,xml,_Fast,AttribAccess_Impl_)
...
class HXCPP_CLASS_ATTRIBUTES AttribAccess_Impl__obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x15538f20 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="haxe.xml._Fast.AttribAccess_Impl_")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"haxe.xml._Fast.AttribAccess_Impl_"); }
		...
		static hx::ObjectPtr< AttribAccess_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
			AttribAccess_Impl__obj *__this = (AttribAccess_Impl__obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(AttribAccess_Impl__obj), false, "haxe.xml._Fast.AttribAccess_Impl_"));
...
#endif /* INCLUDED_haxe_xml__Fast_AttribAccess_Impl_ */ 
