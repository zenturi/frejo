...
HX_DECLARE_STACK_FRAME(_hx_pos_bd32df1abf02b23a_229_new)
...
int h = __o_h.Default(-1);
            	HX_STACKFRAME(&_hx_pos_bd32df1abf02b23a_229_new)
HXLINE( 230)		( ( ::haxe::ds::TreeNode)(__this) )->left = l;
HXLINE( 231)		( ( ::haxe::ds::TreeNode)(__this) )->key = k;
HXLINE( 232)		( ( ::haxe::ds::TreeNode)(__this) )->value = v;
HXLINE( 233)		( ( ::haxe::ds::TreeNode)(__this) )->right = r;
HXLINE( 234)		if ((h == -1)) {
HXLINE( 235)			int _hx_tmp;
HXDLIN( 235)			 ::haxe::ds::TreeNode _this = ( ( ::haxe::ds::TreeNode)(__this) )->left;
HXDLIN( 235)			int _hx_tmp1;
HXDLIN( 235)			if (hx::IsNull( _this )) {
HXLINE( 235)				_hx_tmp1 = 0;
            			}
            			else {
HXLINE( 235)				_hx_tmp1 = _this->_height;
            			}
HXDLIN( 235)			 ::haxe::ds::TreeNode _this1 = ( ( ::haxe::ds::TreeNode)(__this) )->right;
HXDLIN( 235)			int _hx_tmp2;
HXDLIN( 235)			if (hx::IsNull( _this1 )) {
HXLINE( 235)				_hx_tmp2 = 0;
            			}
            			else {
HXLINE( 235)				_hx_tmp2 = _this1->_height;
            			}
HXDLIN( 235)			if ((_hx_tmp1 > _hx_tmp2)) {
HXLINE( 235)				 ::haxe::ds::TreeNode _this2 = ( ( ::haxe::ds::TreeNode)(__this) )->left;
HXDLIN( 235)				if (hx::IsNull( _this2 )) {
HXLINE( 235)					_hx_tmp = 0;
            				}
            				else {
HXLINE( 235)					_hx_tmp = _this2->_height;
            				}
            			}
            			else {
HXLINE( 235)				 ::haxe::ds::TreeNode _this3 = ( ( ::haxe::ds::TreeNode)(__this) )->right;
HXDLIN( 235)				if (hx::IsNull( _this3 )) {
HXLINE( 235)					_hx_tmp = 0;
            				}
            				else {
HXLINE( 235)					_hx_tmp = _this3->_height;
            				}
            			}
HXDLIN( 235)			( ( ::haxe::ds::TreeNode)(__this) )->_height = (_hx_tmp + 1);
            		}
            		else {
HXLINE( 237)			( ( ::haxe::ds::TreeNode)(__this) )->_height = h;
            		}
            	}
