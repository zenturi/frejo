...
HX_DEFINE_STACK_FRAME(_hx_pos_593a9917e735e8fd_4_new,"haxe.MainEvent","new",0x1c640c2b,"haxe.MainEvent.new","/usr/local/lib/haxe/std/haxe/MainLoop.hx",4,0x4a7d9295)
namespace haxe{

void MainEvent_obj::__construct( ::Dynamic f,int p){
            	HX_STACKFRAME(&_hx_pos_593a9917e735e8fd_4_new)
HXLINE(  12)		this->isBlocking = true;
HXLINE(  17)		this->f = f;
HXLINE(  18)		this->priority = p;
HXLINE(  19)		this->nextRun = ( (Float)(-1) );
            	}
