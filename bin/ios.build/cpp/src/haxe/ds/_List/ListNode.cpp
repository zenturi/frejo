...
HX_DEFINE_STACK_FRAME(_hx_pos_d7fe8fcac3c6136e_256_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","/usr/local/lib/haxe/std/haxe/ds/List.hx",256,0x54f95eac)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_d7fe8fcac3c6136e_256_new)
