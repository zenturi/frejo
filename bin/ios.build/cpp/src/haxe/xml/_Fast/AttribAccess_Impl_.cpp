...
HX_LOCAL_STACK_FRAME(_hx_pos_0da7b2a6607f5149_41_resolve,"haxe.xml._Fast.AttribAccess_Impl_","resolve",0x6fc4c2fe,"haxe.xml._Fast.AttribAccess_Impl_.resolve","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",41,0x1680b11e)
namespace haxe{
namespace xml{
namespace _Fast{
...
bool AttribAccess_Impl__obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x15538f20;
}

::String AttribAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_0da7b2a6607f5149_41_resolve)
...
void AttribAccess_Impl__obj::__register()
{
	...
	__mClass->mName = HX_("haxe.xml._Fast.AttribAccess_Impl_",80,ae,41,8a);
