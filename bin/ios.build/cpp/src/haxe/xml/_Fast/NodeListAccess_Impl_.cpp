...
HX_LOCAL_STACK_FRAME(_hx_pos_ac5689a1e86f3255_75_resolve,"haxe.xml._Fast.NodeListAccess_Impl_","resolve",0x24cd4eb4,"haxe.xml._Fast.NodeListAccess_Impl_.resolve","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",75,0x1680b11e)
namespace haxe{
namespace xml{
namespace _Fast{
...
bool NodeListAccess_Impl__obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x76a56972;
}

::Array< ::Dynamic> NodeListAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_ac5689a1e86f3255_75_resolve)
...
HXLINE(  78)					HX_STACK_DO_THROW((HX_("Invalid nodeType ",3b,e0,cb,e1) + x1->nodeType));
            				}
...
void NodeListAccess_Impl__obj::__register()
{
	...
	__mClass->mName = HX_("haxe.xml._Fast.NodeListAccess_Impl_",36,94,bc,4a);
