...
HX_LOCAL_STACK_FRAME(_hx_pos_6c4c10444a1be824_27_resolve,"haxe.xml._Fast.NodeAccess_Impl_","resolve",0x0ad45936,"haxe.xml._Fast.NodeAccess_Impl_.resolve","/usr/local/lib/haxe/std/haxe/xml/Fast.hx",27,0x1680b11e)
namespace haxe{
namespace xml{
namespace _Fast{
...
bool NodeAccess_Impl__obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x37c6e290;
}

 ::Xml NodeAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_6c4c10444a1be824_27_resolve)
...
void NodeAccess_Impl__obj::__register()
{
	...
	__mClass->mName = HX_("haxe.xml._Fast.NodeAccess_Impl_",b8,4c,b4,3f);
