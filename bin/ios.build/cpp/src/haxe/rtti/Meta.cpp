...
HX_LOCAL_STACK_FRAME(_hx_pos_c18a37b9dae291ad_78_getMeta,"haxe.rtti.Meta","getMeta",0x629b4ac1,"haxe.rtti.Meta.getMeta","/usr/local/lib/haxe/std/haxe/rtti/Meta.hx",78,0x880d6bcd)
HX_LOCAL_STACK_FRAME(_hx_pos_c18a37b9dae291ad_93_getFields,"haxe.rtti.Meta","getFields",0x2f4d8575,"haxe.rtti.Meta.getFields","/usr/local/lib/haxe/std/haxe/rtti/Meta.hx",93,0x880d6bcd)
namespace haxe{
namespace rtti{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Meta_obj,getType,return )
 ...
 ::Dynamic Meta_obj::getMeta( ::Dynamic t){
            	HX_STACKFRAME(&_hx_pos_c18a37b9dae291ad_78_getMeta)
HXDLIN(  78)		return t->__Field(HX_("__meta__",45,04,85,b1),hx::paccDynamic);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Meta_obj,getMeta,return )
 ...
 ::Dynamic Meta_obj::getFields( ::Dynamic t){
            	HX_STACKFRAME(&_hx_pos_c18a37b9dae291ad_93_getFields)
HXLINE(  94)		 ::Dynamic meta = ::haxe::rtti::Meta_obj::getMeta(t);
HXLINE(  95)		bool _hx_tmp;
HXDLIN(  95)		if (hx::IsNotNull( meta )) {
HXLINE(  95)			_hx_tmp = hx::IsNull( meta->__Field(HX_("fields",79,8e,8e,80),hx::paccDynamic) );
            		}
            		else {
HXLINE(  95)			_hx_tmp = true;
            		}
HXDLIN(  95)		if (_hx_tmp) {
HXLINE(  95)			return  ::Dynamic(hx::Anon_obj::Create(0));
            		}
            		else {
HXLINE(  95)			return  ::Dynamic(meta->__Field(HX_("fields",79,8e,8e,80),hx::paccDynamic));
            		}
