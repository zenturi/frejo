...
HX_LOCAL_STACK_FRAME(_hx_pos_4c4d6942200fce81_102_set_listener,"msignal.Slot","set_listener",0xb2e0d428,"msignal.Slot.set_listener","msignal/Slot.hx",102,0x8d27aea6)
namespace msignal{
...
HX_DEFINE_DYNAMIC_FUNC0(Slot_obj,get_listener,return )
 ...
 ::Dynamic Slot_obj::set_listener( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_4c4d6942200fce81_102_set_listener)
HXLINE( 104)		if (hx::IsNull( value )) {
HXLINE( 104)			HX_STACK_DO_THROW(HX_("listener cannot be null",13,7e,3e,27));
            		}
HXLINE( 106)		return (this->listener = value);
            	}
