...
HXLINE( 134)		if (this->registrationPossible(listener,( (bool)(once) ))) {
...
HXLINE( 156)		if ((( ( ::msignal::Slot)(existingSlot) )->once != once)) {
HXLINE( 160)			HX_STACK_DO_THROW(HX_("You cannot addOnce() then add() the same listener without removing the relationship first.",19,c7,3c,a5));
            		}
