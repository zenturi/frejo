...
HXLINE(  57)			if (hx::IsNotNull( ::msignal::SlotList_obj::NIL )) {
HXLINE(  57)				HX_STACK_DO_THROW(HX_("Parameters head and tail are null. Use the NIL element instead.",e9,6c,88,75));
            			}
HXLINE(  61)			this->nonEmpty = false;
            		}
            		else {
HXLINE(  63)			if (hx::IsNull( head )) {
HXLINE(  66)				HX_STACK_DO_THROW(HX_("Parameter head cannot be null.",5e,7b,f3,66));
            			}
            			else {
