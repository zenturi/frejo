...
HXLINE( 179)		_done = false;
HXLINE( 181)		{
HXLINE( 181)			::cpp::Pointer<  SDL_Window > window = this->window;
HXDLIN( 181)			::cpp::Pointer<  SDL_Window > tmp = window;
HXDLIN( 181)			::sdl::_SDL::SDL_helper_obj::iOS_set_callback(tmp,1,this->loop_dyn(),null());
            		}
...
void Runtime_obj::loop( ::Dynamic _){
