...
HX_DEFINE_STACK_FRAME(_hx_pos_bd32df1abf02b23a_229_new,"haxe.ds.TreeNode","new",0x88d32f89,"haxe.ds.TreeNode.new","/usr/local/lib/haxe/std/haxe/ds/BalancedTree.hx",229,0xee0b42c4)
namespace haxe{
namespace ds{
...
HXLINE( 230)		this->left = l;
HXLINE( 231)		this->key = k;
HXLINE( 232)		this->value = v;
HXLINE( 233)		this->right = r;
HXLINE( 234)		if ((h == -1)) {
HXLINE( 235)			int _hx_tmp;
HXDLIN( 235)			 ::haxe::ds::TreeNode _this = this->left;
...
HXDLIN( 235)			 ::haxe::ds::TreeNode _this1 = this->right;
...
HXLINE( 235)				 ::haxe::ds::TreeNode _this2 = this->left;
...
HXLINE( 235)				 ::haxe::ds::TreeNode _this3 = this->right;
...
HXDLIN( 235)			this->_height = (_hx_tmp + 1);
            		}
            		else {
HXLINE( 237)			this->_height = h;
            		}
            	}
