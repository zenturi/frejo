...
HXDLIN(  64)				out1->b[(pout - 1)] = base1->__get(((buf >> curbits) & mask));
            			}
            		}
HXLINE(  66)		if ((curbits > 0)) {
HXLINE(  67)			pout = (pout + 1);
HXDLIN(  67)			::Array< unsigned char > base2 = base->b;
HXDLIN(  67)			out1->b[(pout - 1)] = base2->__get(((buf << (nbits - curbits)) & mask));
            		}
...
HXDLIN( 105)				out1[(pout - 1)] = ( (unsigned char)(((buf >> curbits) & 255)) );
            			}
            		}
